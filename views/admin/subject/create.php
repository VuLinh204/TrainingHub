...
<body>
    <div class="container">
        ...
        <form method="POST" action="<?= BASE_URL ?>/admin/subjects/create" class="form-card">
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" 
                              name="description" 
                              class="form-control" 
                              placeholder="Nhập mô tả khóa học..."><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="content" 
                              ...
                              class="form-control" 
                              rows="8"
                              placeholder="Nhập nội dung chi tiết của khóa học..."><?= htmlspecialchars($_POST['content'] ?? '') ?></textarea>
